<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="ip地址" prop="roductIp">
        <el-input
          v-model="queryParams.roductIp"
          placeholder="请输入ip地址"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="productList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="产品备注" align="center" prop="productRemark" />
      ...
      <el-table-column label="ip地址" align="center" prop="roductIp" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="产品备注" prop="productRemark">
          <el-input v-model="form.productRemark" placeholder="请输入产品备注" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除产品类别维护编号为"' + productIds + '"的数据项？').then(function() {
